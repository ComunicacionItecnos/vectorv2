<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Administre y cierre su sesión activa en otros navegadores y dispositivos.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Ingrese su contraseña para confirmar que desea cerrar sesión en todos sus dispositivos y navegadores') }}
