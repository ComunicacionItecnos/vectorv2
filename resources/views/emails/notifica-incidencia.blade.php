...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .gradient {
            background: linear-gradient(to right, #9028df 0%, #e1251b 100%);
        }
        ...
        /* Mobile styles */
        <blade media|%20only%20screen%20and%20(max-device-width%3A%20480px)%2C%0D>only screen and (max-width: 480px) {
            .mpx-10 {
...
<body class="body"
    style="padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; background:#edf1f4; -webkit-text-size-adjust:none;">
    <center>
        <table width="100%" border="0" cellspacing="0" cellpadding="0"
            style="margin: 0; padding: 0; width: 100%; height: 100%;" bgcolor="#edf1f4" class="gwfw">
            <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="mpx-10">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="text-12 c-grey l-grey a-right py-20"
                                                        style="font-size:12px; line-height:16px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; color:#6e6e6e; text-align:center; padding-top: 20px; padding-bottom: 20px;">
                                                        <a href="#" target="_blank"><img
                                                                src="https://factoraguila.com/wp-content/uploads/2020/12/logo_correo.png"
                                                                width="112" height="43" border="0" alt="" /></a>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td style="border-radius: 10px 10px 0 0; bgcolor=" #e1251b">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td class="img-center p-30 px-15"
                                                                                style="font-size:0pt; line-height:0pt; text-align:center; padding: 20px; padding-left: 15px; padding-right: 15px;">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <!-- Logo -->
                                                                                        ...
                                                                                        <td class="pb-50"
                                                                                            ...
                                                                                            <table width="100%"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="text-16 lh-26 a-center pb-25"
                                                                                                        style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
                                                                                                    <b>Fechas de incidencias: </b>
                                                                                                    <p>1.- {{ $incidencias_correo[0]->fecha_incidencia }}</p>
                                                                                                    <p>2.- {{ $incidencias_correo[1]->fecha_incidencia }}</p>
                                                                                                    <p>3.- {{ $incidencias_correo[2]->fecha_incidencia }}</p>
                                                                                                    </td>
                                                                                                </tr>
                                                                                    </tr>
                                                                        </tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="p-50 mpx-15" bgcolor="#e1251b" style="border-radius: 0 0 10px 10px; padding: 50px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
