        ...
        <form wire:submit.prevent="triggerConfirm" enctype="multipart/form-data">
            <div class="p-4 grid">
                                    ...
                                    @foreach ($estadosCivil as $estadoCivil)
                                        @if ($estado_civil === $estadoCivil->id)
                                            <option value="{{ $estadoCivil->id }}" selected>
                                                {{ $estadoCivil->nombre_estado }}</option>
                                        @else
                    ...
                    <div class="row-start-3">
                        <div id="tablaHijos" class="grid mt-4 mb-4" @if (($paternidad == '') | ($paternidad == '0')) style="display: none" @else @endif>
                            ...
                            <div class="flex flex-col">
                                ...
                                <label class="text-center block text-sm font-bold  text-red-700">
                                    *Deben estar rellandos los campos de edad/escolaridad para poder subir
                                    la acta.
                                </label>
                                <label class="text-center block text-sm font-bold  text-red-700">
                                    Si estan desabilitados esto indica que ya contamos con la acta de tu hijo(s).
                                </label>
                                <br>
                                                        ...
                                                        <td>
                                                            @if ($permisoSubiractasRender1 == true)
                                                                <label
                                                                    ...
                                                                    <input type='file' wire:model="actaNacimientoHijo1"
                                                        ...
                                                        <td>
                                                            @if ($permisoSubiractasRender2 == true)
                                                                <label
                                                                    ...
                                                                    <input type='file' wire:model="actaNacimientoHijo2"
                                                                        accept=".pdf" class="hidden" required />
                                                                </label>
                                                            @else
                                                                <label
                                                        ...
                                                        <td>
                                                            @if ($permisoSubiractasRender3 == true)
                                                                <label
                                                                    ...
                                                                    <input type='file' wire:model="actaNacimientoHijo3"
                                                                        accept=".pdf" class="hidden" required />
                                                                </label>
                                                            @else
                                                                <label
                                                        ...
                                                        <td>
                                                            @if ($permisoSubiractasRender4 == true)
                                                                <label
                                                                    ...
                                                                    <input type='file' wire:model="actaNacimientoHijo4"
                                                                        accept=".pdf" class="hidden" required />
                                                                </label>
                                                            @else
                                                                <label
                                                        ...
                                                        <td>
                                                            @if ($permisoSubiractasRender5 == true)
                                                                <label
                                                                    ...
                                                                    <input type='file' wire:model="actaNacimientoHijo5"
                                                                        accept=".pdf" class="hidden" required />
                                                                </label>
                                                            @else
                                                                <label
                                                        ...
                                                        <td>
                                                            @if ($permisoSubiractasRender6 == true)
                                                                <label
                                                                    ...
                                                                    <input type='file' wire:model="actaNacimientoHijo6"
                                                                        accept=".pdf" class="hidden" required />
                                                                </label>
                                                            @else
                                                                <label
                    ...
                    <div class="sm:grid grid-cols-4 gap-2">
                        <div class="mb-2 sm:m-0 col-span-1 col-start-1">
                            ...
                            <input type="text" wire:model="tel_fijo" name="tel_fijo"
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                id="inputTelFijo" value="{{ old('tel_fijo') }}" type="number" pattern="[0-9]*"
                                inputmode="numeric">
                            @error('tel_fijo')
                                <p class="mt-1 mb-1 text-xs text-red-600 italic">
                                    {{ $message }}
                        ...
                        <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                            ...
                            <input type="text" wire:model="tel_movil" name="tel_movil"
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                id="inputTelMovil" value="{{ old('tel_movil') }}" type="number" pattern="[0-9]*"
                                inputmode="numeric">
                            @error('tel_movil')
                                <p class="mt-1 mb-1 text-xs text-red-600 italic">
                                    {{ $message }}
                        ...
                        <div class="mb-2 sm:m-0 col-span-1 col-start-3">
                            ...
                            <input type="text" wire:model="tel_recados" name="tel_recados"
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                id="inputTelRecados" value="{{ old('tel_recados') }}" type="number" pattern="[0-9]*"
                                inputmode="numeric">
                            @error('tel_recados')
                                <p class="mt-1 mb-1 text-xs text-red-600 italic">
                                    {{ $message }}
                                ...
                                <div class="row-start-2 gap-2">
                                    <div class="grid row-start-1 grid-cols-2 gap-2">
                                        ...
                                        <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                            ...
                                            <input type="text" wire:model="parentesco_contacto1"
                                ...
                                <div class="row-start-2 gap-2">
                                    <div class="grid row-start-1 grid-cols-2 gap-2">
                                        ...
                                        <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                            <label for="parentesco_contacto"
                                                class="block text-sm font-medium text-gray-700">Parentesco</label>
                                            <input type="text" wire:model="parentesco_contacto2"
                                                id="parentesco_contacto"
                                                class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        </div>
                                    </div>
                                ...
                                <div class="row-start-2 gap-2">
                                    <div class="grid row-start-1 grid-cols-2 gap-2">
                                        ...
                                        <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                            <label for="parentesco_contacto"
                                                class="block text-sm font-medium text-gray-700">Parentesco</label>
                                            <input type="text" wire:model="parentesco_contacto3"
                                                id="parentesco_contacto"
                                                class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        </div>
                                    </div>
                                ...
                                <div class="row-start-2 gap-2">
                                    <div class="grid row-start-1 grid-cols-2 gap-2">
                                        ...
                                        <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                            <label for="parentesco_contacto"
                                                class="block text-sm font-medium text-gray-700">Parentesco</label>
                                            <input type="text" wire:model="parentesco_contacto4"
                                                id="parentesco_contacto"
                                                class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        </div>
                                    </div>
                ...
                @if ($permisoSubircomprobante2 === true)
                    <div class="mt-2">
                        <label class="text-center block text-sm font-medium opacity-50 text-gray-700">Desabilitado
                            debido a que ya contamos con su comprobante de domicilio</label>
                    </div>
                    <div class="h-16 p-4 opacity-50">
                        <label
                            ...
                            <input type='file' name="comprobante" id="comprobante" wire:model="comprobante" disabled
