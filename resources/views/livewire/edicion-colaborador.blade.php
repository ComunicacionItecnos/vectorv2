                        ...
                        <form action="#" method="POST">
                            <div class="overflow-hidden shadow sm:rounded-md">
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                            ...
                                            <div class="grid grid-flow-col grid-rows-3 grid-cols-3 gap-3">
                                                ...
                                                <div class="row-start-3 col-start-3 col-span-1">
                                                    <label class="block text-sm font-black text-gray-700"
                                                        ...
                                                        Seguro
                                                        Social</label>
                                                    <input type="text" wire:model="no_seguro_social"
                                                        name="no_seguro_social" id="inputno_seguro_social"
                                                        value="{{ old('no_seguro_social') }}"
                                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    ...
                                    {{-- Tabla Hijos --}}
                                    <div id="tablaHijos" class="grid mt-4 mb-4" @if (($paternidad=='' ) |
                                        (($paternidad=='0' ) | (auth()->user()->role_id == 2) | (auth()->user()->role_id
                ...
                <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
                    <table name="tablaContactos" class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="tb_contactos">
                            <tr>
                                <td><input type="text" wire:model="nombre_contacto1" id="nombre_contacto"
                                ...
                                <td><input type="text" wire:model="parentesco_contacto1" id="parentesco_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                ...
                                <td><input type="text" wire:model="telefono_contacto1" id="telefono_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                ...
                                <td><input type="text" wire:model="domicilio_contacto1" id="domicilio_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <tr>
                                <td><input type="text" wire:model="nombre_contacto2" id="nombre_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="parentesco_contacto2" id="parentesco_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="telefono_contacto2" id="telefono_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="domicilio_contacto2" id="domicilio_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" wire:model="nombre_contacto3" id="nombre_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="parentesco_contacto3" id="parentesco_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="telefono_contacto3" id="telefono_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="domicilio_contacto3" id="domicilio_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" wire:model="nombre_contacto4" id="nombre_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="parentesco_contacto4" id="parentesco_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="telefono_contacto4" id="telefono_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                <td><input type="text" wire:model="domicilio_contacto4" id="domicilio_contacto"
                                        class="block w-full mt-1 mb-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </td>
                                </td>
                            </tr>
            ...
            <div class="col-span-1 sm:col-span-1">
                ...
                <div class="flex justify-center">
                    <label for="autoEvalGen" class="flex items-center cursor-pointer">
                        ...
                        <!-- toggle -->
                        <div class="relative">
                            <input wire:model="autoEvalGen" name="autoEvalGen" id="autoEvalGen" type="checkbox"
                                class="hidden" />
                            <!-- path -->
            ...
            <div class="col-span-1 sm:col-span-1">
                ...
                <div class="flex justify-center">
                    <label for="autoEvalAsig" class="flex items-center cursor-pointer">
                        ...
                        <!-- toggle -->
                        <div class="relative">
                            <input wire:model="autoEvalAsig" name="autoEvalAsig" id="autoEvalAsig" type="checkbox"
                                class="hidden" />
                            <!-- path -->
                            <div class="toggle-path bg-red-500 w-9 h-5 rounded-full shadow-inner">
                            </div>
            ...
            <div class="col-span-1 sm:col-span-1">
                ...
                <div class="flex justify-center">
                    <label for="evalGen" class="flex items-center cursor-pointer">
                        ...
                        <!-- toggle -->
                        <div class="relative">
                            <input wire:model="evalGen" name="evalGen" id="evalGen" type="checkbox" class="hidden" />
                            <!-- path -->
                            <div class="toggle-path bg-red-500 w-9 h-5 rounded-full shadow-inner">
                            </div>
                            <!-- crcle -->
            ...
            <div class="col-span-1 sm:col-span-1">
                ...
                <div class="flex justify-center">
                    <label for="evalAsig" class="flex items-center cursor-pointer">
                        ...
                        <!-- toggle -->
                        <div class="relative">
                            <input wire:model="evalAsig" name="evalAsig" id="evalAsig" type="checkbox" class="hidden" />
                            <!-- path -->
                            <div class="toggle-path bg-red-500 w-9 h-5 rounded-full shadow-inner">
                            </div>
                            <!-- crcle -->
