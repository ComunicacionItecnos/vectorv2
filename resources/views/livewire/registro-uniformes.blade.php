<div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
    ...
    <section class="@if ($mostrarNuevoRegistro) @else hidden @endif">
        ...
        {{-- Tallas --}}
        <fieldset class="grid gap-6 p-6 rounded-lg shadow-md @if ($busquedaNuevo) @else hidden @endif">
                        ...
                        <div class="sm:grid row-start-1 grid-cols-3 gap-2 py-4">
                            <div class="mb-2 sm:m-0 col-span-1 col-start-2 @if ($seleccionPersonal) @else hidden @endif">
                                <button type="button" wire:click="abrirModal"
                                    class="ml-1 inline-flex justify-center px-4 py-2 text-sm font-black text-white bg-green-600 border border-transparent rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"">
                                        Siguiente
                                    </button>
                                </div>
                            </div>
