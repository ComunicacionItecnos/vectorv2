<div class="flex flex-col">
        ...
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 m-2">
                <div class="col-span-1 sm:col-span-1 flex justify-start items-center">
                    <label for="nombre_nivel" class="block text-4xl font-medium text-gray-700">Niveles</label>
                </div>
                <div class="col-span-1 sm:col-span-1 flex justify-end items-center">
                    <button wire:click="confirmNivelAdd"
                            ...
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    <div class="flex text-left">
                                        Nivel
                                        @if ($sortAsc)
                                            <span class="cursor-pointer" wire:click="sortBy('nombre_nivel')">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 20 20" fill="currentColor">
                                                    <path
                                                        d="M3 3a1 1 0 000 2h11a1 1 0 100-2H3zM3 7a1 1 0 000 2h7a1 1 0 100-2H3zM3 11a1 1 0 100 2h4a1 1 0 100-2H3zM15 8a1 1 0 10-2 0v5.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L15 13.586V8z" />
                        ...
                        @foreach ($niveles as $nivel)
                            <tr>
                                ...
                                <td class="flex justify-items-center px-6 py-4 text-sm font-medium text-right
                                        whitespace-nowrap">
                                    <button wire:click="confirmNivelEdit({{ $nivel->id }})"
                                    ...
                                    <button wire:click="triggerConfirm({{ $nivel->id }})"
    ...
    {{-- Modal para agregar una nueva nivel --}}
    <x-jet-dialog-modal wire:model="confirmNivelAdd">
        <x-slot name="title">
            {{ __('Agregar nuevo nivel') }}
        </x-slot>

        <x-slot name="content">
            {{ __('Ingresa el nombre del nuevo nivel') }}

            <div class="mt-4">
                <input type="text" wire:model="nombre_nivel" name="nombre_nivel" id="nombre_nivel"
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$set('confirmNivelAdd', false)" wire:loading.attr="disabled">
                {{ __('Cancelar') }}
    ...
    {{-- Modal para editar un nivel existente --}}

    <x-jet-dialog-modal wire:model="confirmNivelEdit">
        <x-slot name="title">
            {{ __('Actualizar nivel') }}
        </x-slot>

        <x-slot name="content">
            {{ __('Ingresa el nuevo nombre del nivel') }}
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$set('confirmNivelEdit', false)" wire:loading.attr="disabled">
                {{ __('Cancelar') }}
            </x-jet-secondary-button>
