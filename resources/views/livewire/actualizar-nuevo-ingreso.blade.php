    ...
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                <div class="max-w-md mx-auto">
                    <div>
                        @if ($currentStep == 1)
                            <img src="{{ asset('images/encabezadosNuevoIngreso/Banner_Screen-2-01.png') }}"
                                class="object-center" />
                        @endif
                        @if ($currentStep == 2 || $currentStep == 3)
                            <img src="{{ asset('images/encabezadosNuevoIngreso/Banner_Screen-9-01.png') }}"
                                class="object-center" />
                        @endif
                    </div>
                            ...
                            <form wire:submit.prevent="triggerConfirm" enctype="multipart/form-data">
                                ...
                                <div class="h-16 p-8 grid grid-cols-3">
                                    @if ($currentStep == 1 || $currentStep == 2 || $currentStep == 3)
                                        ...
                                        <div
                                            class="flex justify-start px-2 col-end-7 col-span-2 @if ($currentStep == 3) hidden @endif">
                                            <button type="button"
                                        ...
                                        <div
                                            class="flex justify-end px-2 col-end-7 col-span-2 @if ($currentStep != 3) hidden @endif">
                                            <button type="submit"
