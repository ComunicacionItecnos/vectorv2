                        ...
                        <div class="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                            ...
                            <p class="space-y-6 block text-base font-medium text-gray-700">
                                2) Los campos con el siguiente signo <span
                                    class="mt-1 mb-1 text-base text-red-600 italic m-1">+</span> te permiten subir más
                                de un archivo.
                            </p>
                        ...
                        <form wire:submit.prevent="triggerConfirm" enctype="multipart/form-data">
                            ...
                            <div class="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        <label class="block text-base font-medium text-gray-700" for="nombre_2">Segundo
                                            nombre</label>
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-1">
                                        <label class="block text-base font-medium text-gray-700" for="ap_paterno"><span
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        <label class="block text-base font-medium text-gray-700" for="ap_materno"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        <label for="genero_id" class="block text-base font-medium text-gray-700"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                            Género</label>
                            ...
                            <div class="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        ...
                                        <label
                                            ...
                                            <input type='file' wire:model="actaMatrimonio" accept=".pdf" class="hidden"
                                                disabled />
                                        </label>
                                        @endif
                                    </div>
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        ...
                                        @if ($paternidad_id == 1)
                                        <label class="block text-base font-medium text-gray-700" for="actasHijo">
                                            <span class="mt-1 mb-1 text-base text-red-600 italic">+</span> Actas de los
                                            hijos</label>
                                        <label
                                            class="flex flex-col my-auto items-center px-4 py-2 mt-1 tracking-wide text-blue-800 uppercase bg-white border border-blue-600 rounded-lg shadow-lg cursor-pointer w-68 hover:bg-blue-500 hover:text-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                            ...
                                            <input type='file' wire:model="actasHijo" accept=".pdf" class="hidden"
                                                multiple />
                                        </label>
                                        @else
                                        <label class="block text-base font-medium text-gray-700" for="actasHijo">Actas
                                            de los hijos</label>
                                        <label
                                            class="cursor-not-allowed opacity-50 flex flex-col my-auto items-center px-4 py-2 mt-1 tracking-wide text-blue-800 uppercase bg-white border border-blue-600 rounded-lg shadow-lg cursor-pointer w-68 hover:bg-blue-500 hover:text-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-1">
                                        <label class="block text-base font-medium text-gray-700" for="curpDoc"><span
                                        ...
                                        <label
                                            ...
                                            <input type='file' wire:model="curpDoc" accept=".pdf" class="hidden" />
                                        </label>
                                        @error('curpDoc')
                                        <p class="mt-1 mb-1 text-xs text-red-600 italic">
                                            {{ $message }}
                            ...
                            <div class="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-1">
                                        <label class="block text-base font-medium text-gray-700" for="rfc"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                            RFC</label>
                                        <input type="text" wire:model="rfc" name="rfc" id="rfc" value="{{ old('rfc') }}"
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        <label for="rfcDoc" class="block text-base font-medium text-gray-700"><span
                                        ...
                                        <label
                                            ...
                                            <input type='file' wire:model="rfcDoc" accept=".pdf" class="hidden" />
                                        </label>
                                        @error('rfcDoc')
                                        <p class="mt-1 mb-1 text-xs text-red-600 italic">
                                            {{ $message }}
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        <label for="altaImssDoc" class="block text-base font-medium text-gray-700"><span
                                        ...
                                        <label
                                            ...
                                            <input type='file' wire:model="altaImssDoc" accept=".pdf" class="hidden" />
                                        </label>
                                        @error('altaImssDoc')
                                        <p class="mt-1 mb-1 text-xs text-red-600 italic">
                                            {{ $message }}
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        ...
                                        <label for="cartillaMilitar" class="block text-base font-medium text-gray-700">
                                            Cartilla militar
                                        </label>
                                        <label
                                            class="flex flex-col my-auto items-center px-4 py-2 mt-1 tracking-wide text-blue-800 uppercase bg-white border border-blue-600 rounded-lg shadow-lg cursor-pointer w-68 hover:bg-blue-500 hover:text-white">
                            ...
                            <div class="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        <label class="block text-base font-medium text-gray-700" for="estado"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                            Estado</label>
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-1">
                                        <label class="block text-base font-medium text-gray-700" for="municipio"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                            Municipio</label>
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-2 col-start-2">
                                        <label class="block text-base font-medium text-gray-700" for="domicilio"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                            Calle</label>
                                ...
                                <div class="sm:grid row-start-1 grid-cols-4 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-2 col-start-3">
                                        <label class="block text-base font-medium text-gray-700" for="colonia"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                            Colonia</label>
                            ...
                            <div class="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-1">
                                        <label class="block text-base font-medium text-gray-700" for="tel_fijo"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                            Telefono fijo</label>
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        <label class="block text-base font-medium text-gray-700" for="tel_movil"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    <div class="mb-2 sm:m-0 col-span-2 col-start-1">
                                        <label class="block text-base font-medium text-gray-700" for="correo"><span
                            ...
                            <div class="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                                ...
                                <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                    ...
                                    <input type="text" wire:model="especialidadEstudios" name="especialidadEstudios"
                                        id="especialidadEstudios" value="{{ old('especialidadEstudios') }}"
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-base">
                            ...
                            <div class="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        ...
                                        <label
                                            ...
                                            <input type='file' wire:model="cartasRecomendacion" accept=".pdf" multiple
                                                class="hidden" />
                                        </label>
                                ...
                                <div class="sm:grid row-start-1 grid-cols-2 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-2">
                                        <label for="buroCredito" class="block text-base font-medium text-gray-700"><span
                                        ...
                                        <label
                                            ...
                                            <input type='file' wire:model="buroCredito" accept=".pdf" class="hidden" />
                                        </label>
                                        @error('buroCredito')
                                        <p class="mt-1 mb-1 text-xs text-red-600 italic">
                                            {{ $message }}
                                ...
                                <div class="sm:grid row-start-1 grid-cols-1 gap-2">
                                    ...
                                    <div class="mb-2 sm:m-0 col-span-1 col-start-1">
                                        <label for="foto" class="block text-base font-medium text-gray-700"><span
                                                class="mt-1 mb-1 text-base text-red-600 italic">*</span>
                                            Fotografia
                                        </label>
                                        <label
