<div class="py-10 grid max-w-5xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols">
    ...
    <section class="sm:px-6 lg:px-4 xl:px-6 pt-4 pb-4 sm:pb-6 lg:pb-4 xl:pb-6 space-y-4 bg-white shadow-lg rounded-xl  page__style perfil  @if($mostrarCandidato) @else hidden @endif">
        ...
        @else
            <form wire:submit.prevent="triggerConfirm" class="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
                    ...
                    <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                        <div class="col-span-full sm:col-span-6">
                            <img src="{{ Storage::url($foto) }}" alt="Profile face"
                                class="p-1 w-24 h-24 mx-auto rounded-full  object-cover ring-2 ring-offset-4 ring-violet-400" loading="lazy">
                        </div>
