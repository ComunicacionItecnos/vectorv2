...
class ListaVehiculosExternos extends Component
{
    ...
    {
        return view('livewire.lista-vehiculos-externos', [
            'vehiculos' => DB::table('colaborador_estacionamiento_externo')->where('externo_id', 'LIKE', "%{$this->search}%")
